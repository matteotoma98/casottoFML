...
public class SendEmail {
    ...
    public static void sendMailPrenSpiaggiaCliente(String recipient, int id_ombrellone, double prezzo) throws Exception {
        Properties properties = new Properties();
        properties.put("mail.smtp.starttls.enable", "true");
        properties.setProperty("mail.transport.protocol", "smtp");
        properties.setProperty("mail.host", "smtp.gmail.com");
        ...
        Message message = prepareMessaggePrenSpiaggiaCliente(session, myAccountEmail, recipient, id_ombrellone, prezzo);
        Transport.send(message);
        System.out.println("Messaggio inviato correttamente");
    }

    private static Message prepareMessaggePrenSpiaggiaCliente(Session session, String myAccountEmail, String recipient, int id_ombrellone, double prezzo) {
        try {
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress(myAccountEmail));
            message.setRecipient(Message.RecipientType.TO, new InternetAddress(recipient));
