...
public class Scontrino {
        ...
        public String toString() {
            return "Scontrino{" +
                    ...
                    ", id_ombrellone=" + ombrellone.getId_ombrellone() +
                    ", prezzo_totale=" + prezzo_totale +
                    '}';
        }

        public Scontrino(int id_scontrino, Date data_scontrino, Ombrellone ombrellone,double prezzo_totale) {
                this.id_scontrino = id_scontrino;
                this.data_scontrino = data_scontrino;
                this.a = ombrellone.getId_ombrellone();
