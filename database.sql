...
LOCK
TABLES `addettoattivita` WRITE;
/*!40000 ALTER TABLE `addettoattivita` DISABLE KEYS */;
INSERT INTO `addettoattivita`
VALUES ('addettoattivita@studenti.unicam.it', 'Addetto', 'Attivita', 1);
...
LOCK
TABLES `addettobar` WRITE;
/*!40000 ALTER TABLE `addettobar` DISABLE KEYS */;
INSERT INTO `addettobar`
VALUES (1, 'fchiocchi@libero.it', 'Addetto', 'Bar');
...
LOCK
TABLES `addettospiaggia` WRITE;
/*!40000 ALTER TABLE `addettospiaggia` DISABLE KEYS */;
INSERT INTO `addettospiaggia`
VALUES (1, 'francesco.chiocchi@divini.org', 'Addetto', 'Spiaggia');
...
LOCK
TABLES `attivita` WRITE;
/*!40000 ALTER TABLE `attivita` DISABLE KEYS */;
INSERT INTO `attivita`
VALUES ('Beach', 4, 3, 'Pallone Beach', '2', '2022-05-11 16:00:00', '2022-05-11 18:00:00'),
       ('Calcio', 5, 2, 'Pallone Calcio', '2', '2022-04-29 15:00:00', '2022-04-29 16:00:00'),
       ('prova', NULL, 4, 'prova', '2', NULL, NULL),
       ('prova2', NULL, 5, 'prova', '2', NULL, NULL),
       ('prova3', NULL, 6, 'prova', '2', NULL, NULL),
       ('Zumba', 4, 1, 'Cassa', '1', '2022-09-10 00:00:00', '2022-09-10 00:00:00');
...
LOCK
TABLES `cliente` WRITE;
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
INSERT INTO `cliente`
VALUES ('toma', 'toma', 'matteo', 1);
...
LOCK
TABLES `gestore` WRITE;
/*!40000 ALTER TABLE `gestore` DISABLE KEYS */;
INSERT INTO `gestore`
VALUES ('Francesco', 'Chiocchi', 'francesco.chiocchi@studenti.unicam.it'),
       ('Lorenzo', 'Caporossi', 'lorenzo.caporossi@studenti.unicam.it'),
       ('Matteo', 'Toma', 'matteo.toma@studenti.unicam.it');
...
LOCK
TABLES `pagamentoombrellone` WRITE;
/*!40000 ALTER TABLE `pagamentoombrellone` DISABLE KEYS */;
INSERT INTO `pagamentoombrellone`
VALUES ('app', 1, 1, '2022-05-24 00:00:00');
...
LOCK
TABLES `prenotazioneattivita` WRITE;
...
LOCK
TABLES `prenotazionespiaggia` WRITE;
/*!40000 ALTER TABLE `prenotazionespiaggia` DISABLE KEYS */;
INSERT INTO `prenotazionespiaggia`
VALUES (1, '2022-06-12', '2022-06-13', 1, 1, 1, 'matteo');
...
LOCK
TABLES `preparazioneordine` WRITE;
/*!40000 ALTER TABLE `preparazioneordine` DISABLE KEYS */;
INSERT INTO `preparazioneordine`
VALUES (1, 1);
...
LOCK
TABLES `prodottibar` WRITE;
/*!40000 ALTER TABLE `prodottibar` DISABLE KEYS */;
INSERT INTO `prodottibar`
VALUES (1, 'Patatine San Carlo', 1, 7, 1),
       (2, 'Bruschettine', 2, 11, 1),
       (3, 'Tramezzini', 3, 14, 5),
       (4, 'Kinder Bueno', 2, 10, 1),
       (5, 'Spritz', 4, 20, 5),
       (6, 'Estathe Pesca', 2, 20, 1),
       (7, 'Estathe Limone', 2, 20, 1),
       (8, 'Acqua', 1, 48, 1),
       (9, 'Cono ', 2, 8, 1),
       (10, 'Ghiacciolo Menta', 1.5, 5, 1),
       (11, 'Giacciolo Limone', 5, 5, 1);
...
LOCK
TABLES `tariffaprezzi` WRITE;
/*!40000 ALTER TABLE `tariffaprezzi` DISABLE KEYS */;
INSERT INTO `tariffaprezzi`
VALUES (1, 2, 6, '8'),
       (2, 2, 6, '8'),
       (3, 2, 6, '8'),
       (4, 2, 4, '6'),
...
INSERT INTO `utente`
VALUES ('addettoattivita', 'addettoattivita', 'addetto_attivita', 'addettoattivita@studenti.unicam.it', 'Addetto',
        'Attivita'),
       ('addettobar', 'addettobar', 'addetto_bar', 'fchiocchi@libero.it', 'Addetto', 'Bar'),
       ('addettospiaggia', 'addettospiaggia', 'addetto_spiaggia', 'francesco.chiocchi@divini.org', 'Addetto',
        'Spiaggia'),
       ('fracs_xyz', 'casottoFML', 'gestore', 'francesco.chiocchi@studenti.unicam.it', 'Francesco', 'Chiocchi'),
       ('lore_capo', 'casottoFML', 'gestore', 'lorenzo.caporossi@studenti.unicam.it', 'Lorenzo', 'Caporossi'),
       ('matteotoma_98', 'casottoFML', 'gestore', 'matteo.toma@studenti.unicam.it', 'Matteo', 'Toma'),
       ('fra', 'fracs', 'cliente', 'chio', 'fra', 'fracs'),
       ('francesco', 'francesco', 'cliente', 'fchiocchi1@gmail.com', 'Francesco', 'Chiocchi'),
       ('lorenzo', 'lorenzo', 'cliente', 'caporossilorenzo98@gmail.com', 'Lorenzo', 'Caporossi'),
       ('matteo', 'matteo', 'cliente', 'matteo', 'toma', 'toma'),
       ('matteot', 'matteot', 'cliente', 'matteotoma98@hotmail.it', 'Matteo', 'T'),
       ('prova', 'prova', 'cliente', 'prova', 'prova', 'cliente');
...
-- Dump completed on 2022-05-27 16:02:10
